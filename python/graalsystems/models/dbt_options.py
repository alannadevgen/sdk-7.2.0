...
class DbtOptions(Options):
    """
    DbtOptions
    """ # noqa: E501
    type: Optional[StrictStr] = 'dbt'
    profile: Optional[StrictStr] = None
    adapter: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["env", "docker_image", "instance_type", "type", "profile", "adapter"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'dbt',
