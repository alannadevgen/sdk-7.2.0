...
class S3Connector(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='s3', description="Connection to a S3 bucket.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "options": S3ConnectorOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None
        })
        return _obj
