...
class Details(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'issue': 'IssueDetails','quota': 'QuotaDetails','subscription': 'SubscriptionDetails'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("Details failed to lookup discriminator value from " +
...
Details.model_rebuild(raise_errors=False)
