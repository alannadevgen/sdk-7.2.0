...
class KnimeOptions(Options):
    """
    KnimeOptions
    """ # noqa: E501
    type: Optional[StrictStr] = 'knime'
    workflow: Optional[StrictStr] = None
    archive: Optional[Library] = None
    preferences: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["env", "docker_image", "instance_type", "type", "workflow", "archive", "preferences"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'knime',
            "workflow": obj.get("workflow"),
            "archive": Library.from_dict(obj.get("archive")) if obj.get("archive") is not None else None,
