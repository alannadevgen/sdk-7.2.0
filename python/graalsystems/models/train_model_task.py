...
class TrainModelTask(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default='train_model', description="Type of the train model task.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('train_model'):
            raise ValueError("must be one of enum values ('train_model')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": RandomForest.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "dependency": obj.get("dependency"),
            "type": obj.get("type") if obj.get("type") is not None else 'train_model'
        })
        return _obj
