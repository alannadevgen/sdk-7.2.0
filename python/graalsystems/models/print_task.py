...
class PrintTask(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='print', description="Type of the printtask.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": PrintParams.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "dependency": obj.get("dependency"),
            "type": obj.get("type") if obj.get("type") is not None else 'print'
        })
        return _obj
