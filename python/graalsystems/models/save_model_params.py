...
class SaveModelParams(BaseModel):
    ...
    SaveModelParams
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='model', description="Type of object model.")
    connector: Connector
    object: ParametersToWriteAFile2
    __properties: ClassVar[List[str]] = ["type", "connector", "object"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'model',
            "connector": Connector.from_dict(obj.get("connector")) if obj.get("connector") is not None else None,
            "object": ParametersToWriteAFile2.from_dict(obj.get("object")) if obj.get("object") is not None else None
        })
        return _obj
