...
class LikeFilter(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='like', description="Operator for LIKE filter.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('like'):
            raise ValueError("must be one of enum values ('like')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "left": obj.get("left"),
            "right": obj.get("right"),
            "type": obj.get("type") if obj.get("type") is not None else 'like'
        })
        return _obj
