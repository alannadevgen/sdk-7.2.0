...
class AzureConnector(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='azure', description="Connect to an Azure Blob Storage.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'azure',
            "options": AzureConnectorOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None
        })
        return _obj
