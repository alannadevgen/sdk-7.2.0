...
class OrderTask(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='order', description="Type of the order task.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": OrderParams.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "dependency": obj.get("dependency"),
            "type": obj.get("type") if obj.get("type") is not None else 'order'
        })
        return _obj
