...
class LessThanFilter(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='less', description="Operator for LESS THAN filter.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('less'):
            raise ValueError("must be one of enum values ('less')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "left": obj.get("left"),
            "right": obj.get("right"),
            "type": obj.get("type") if obj.get("type") is not None else 'less'
        })
        return _obj
