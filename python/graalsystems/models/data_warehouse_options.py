...
class DataWarehouseOptions(BaseModel):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'db2': 'DB2Options','mariadb': 'MariaDBOptions','mysql': 'MySQLOptions','oracle': 'OracleOptions','postgresql': 'PostgreSQLOptions','snowflake': 'SnowflakeOptions','starburst': 'StarburstOptions','synapse': 'SynapseOptions','trino': 'TrinoOptions'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DataWarehouseOptions failed to lookup discriminator value from " +
...
DataWarehouseOptions.model_rebuild(raise_errors=False)
