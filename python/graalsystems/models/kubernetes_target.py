...
class KubernetesTarget(Target):
    ...
    KubernetesTarget
    """ # noqa: E501
    type: Optional[StrictStr] = 'kubernetes'
    subtype: Optional[StrictStr] = None
    mode: Optional[StrictStr] = None
    context: Optional[StrictStr] = None
    kubeconfig: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "metadata", "subtype", "mode", "context", "kubeconfig"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'kubernetes',
