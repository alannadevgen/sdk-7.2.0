...
class DataWarehousePage(BaseModel):
    """
    typed Page
    """ # noqa: E501
    number: Optional[StrictInt] = None
    size: Optional[StrictInt] = None
    content: Optional[List[DataWarehouse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [DataWarehouse.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None
        })
        return _obj
