...
class OrFilter(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='or', description="Operator for OR filter.")
    conditions: List[ANDConditionInner] = Field(description="Condition for OR filter.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('or'):
            raise ValueError("must be one of enum values ('or')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'or',
            "conditions": [ANDConditionInner.from_dict(_item) for _item in obj.get("conditions")] if obj.get("conditions") is not None else None
        })
        return _obj
