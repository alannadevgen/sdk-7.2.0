...
class TrialDetails(Details1):
    """
    TrialDetails
    """ # noqa: E501
    type: Optional[StrictStr] = 'trial'
    expire: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["type", "expire"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'trial',
