...
class JoinTask(BaseModel):
    ...
    params: JoinParams
    dependency: Annotated[List[StrictStr], Field(min_length=2, max_length=2)] = Field(description="List of all dependencies of the task.")
    type: Optional[StrictStr] = Field(default='join', description="Type of the join task.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": JoinParams.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "dependency": obj.get("dependency"),
            "type": obj.get("type") if obj.get("type") is not None else 'join'
        })
        return _obj
