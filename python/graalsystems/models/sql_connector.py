...
class SQLConnector(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='sql', description="Connection to a SQL server.")
    options: Optional[Dict[str, Any]] = Field(default=None, description="Options to connect to a SQL server.")
