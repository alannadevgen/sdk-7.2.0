...
class FilterTask(BaseModel):
    ...
    params: FilterTaskParameters
    dependency: List[StrictStr] = Field(description="List of all dependencies of the task.")
    type: Optional[StrictStr] = Field(default='filter', description="Type of the filter task.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('filter'):
            raise ValueError("must be one of enum values ('filter')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": FilterTaskParameters.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "dependency": obj.get("dependency"),
            "type": obj.get("type") if obj.get("type") is not None else 'filter'
        })
        return _obj
