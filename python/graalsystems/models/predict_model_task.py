...
class PredictModelTask(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default='predict_model', description="Type of the predict model task.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('predict_model'):
            raise ValueError("must be one of enum values ('predict_model')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'predict_model'
        })
        return _obj
