...
class Notification(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ai': 'AzureLogAnalyticsNotification','eventhub': 'EventHubNotification','mail': 'MailNotification','webhook': 'WebHookNotification'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("Notification failed to lookup discriminator value from " +
