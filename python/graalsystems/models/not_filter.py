...
class NotFilter(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='not', description="Operator for NOT filter.")
    condition: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["type", "condition"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'not',
