...
class Estimation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["currency", "amount", "requests"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "requests": [Request.from_dict(_item) for _item in obj.get("requests")] if obj.get("requests") is not None else None
        })
        return _obj
