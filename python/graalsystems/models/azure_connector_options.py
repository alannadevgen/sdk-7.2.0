...
class AzureConnectorOptions(BaseModel):
    """
    ...
    """ # noqa: E501
    storage_name: StrictStr = Field(description="Name of the Azure Blob Storage.")
    sas_token: StrictStr = Field(description="SAS token for Azure Blob Storage connection.")
    container: StrictStr = Field(description="Name of the Azure Blob Storage container.")
    __properties: ClassVar[List[str]] = ["storage_name", "sas_token", "container"]
