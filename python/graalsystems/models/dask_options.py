...
class DaskOptions(Options):
    """
    DaskOptions
    """ # noqa: E501
    type: Optional[StrictStr] = 'dask'
    ...
    number_workers_max: Optional[Union[StrictFloat, StrictInt]] = None
    driver_instance_type: Optional[StrictStr] = None
    worker_instance_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["env", "docker_image", "instance_type", "type", "package_name", "module_name", "function_name", "number_workers", "number_workers_max", "driver_instance_type", "worker_instance_type"]
