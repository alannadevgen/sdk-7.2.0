...
class Workspace(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "version", "type", "instance_type", "owner", "infrastructure_id", "device_id", "public_url", "status", "created", "updated", "labels", "metadata"]
