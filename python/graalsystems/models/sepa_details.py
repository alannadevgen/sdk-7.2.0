...
class SepaDetails(Details1):
    """
    SepaDetails
    """ # noqa: E501
    type: Optional[StrictStr] = 'sepa'
    iban: Optional[StrictStr] = None
    bank_code: Optional[StrictStr] = None
    country: Optional[StrictStr] = None
    branch_code: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "iban", "bank_code", "country", "branch_code"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'sepa',
            "iban": obj.get("iban"),
