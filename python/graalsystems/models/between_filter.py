...
class BetweenFilter(BaseModel):
    ...
    right: List[StrictStr]
    type: Optional[StrictStr] = Field(default='between', description="Operator for BETWEEN filter (range).")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('between'):
            raise ValueError("must be one of enum values ('between')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "left": obj.get("left"),
            "right": obj.get("right"),
            "type": obj.get("type") if obj.get("type") is not None else 'between'
        })
        return _obj
