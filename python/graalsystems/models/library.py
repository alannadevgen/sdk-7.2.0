...
class Library(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'cran': 'CranLibrary','file': 'FileLibrary','git': 'GitLibrary','maven': 'MavenLibrary','pypi': 'PyPiLibrary'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("Library failed to lookup discriminator value from " +
...
Library.model_rebuild(raise_errors=False)
