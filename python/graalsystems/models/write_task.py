...
class WriteTask(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    params: WriteTaskParameters
    dependency: List[StrictStr] = Field(description="List of all dependencies of the task.")
    type: Optional[StrictStr] = Field(default='write', description="Type of the write task.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": WriteTaskParameters.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "dependency": obj.get("dependency"),
            "type": obj.get("type") if obj.get("type") is not None else 'write'
        })
        return _obj
