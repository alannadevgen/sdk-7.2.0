...
class ReadTask(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    params: ReadTaskParameters
    type: Optional[StrictStr] = Field(default='read', description="Type of the read task.")
    dependency: Optional[List[StrictStr]] = Field(default=None, description="List of all dependencies of the task (optional).")
    __properties: ClassVar[List[str]] = ["id", "params", "type", "dependency"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": ReadTaskParameters.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "type": obj.get("type") if obj.get("type") is not None else 'read',
