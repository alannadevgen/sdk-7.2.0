...
class HadoopOptions(Options):
    """
    HadoopOptions
    """ # noqa: E501
    type: Optional[StrictStr] = 'hadoop'
    application_type: Optional[StrictStr] = None
    application_id: Optional[StrictStr] = None
    job_id: Optional[StrictStr] = None
    command: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["env", "docker_image", "instance_type", "type", "application_type", "application_id", "job_id", "command"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'hadoop',
