...
class AndFilter(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='and', description="Operator for AND filter.")
    conditions: List[ANDConditionInner] = Field(description="Condition for AND filter.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'and',
