...
class DistinctTask(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='distinct', description="Type of the distinct task.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('distinct'):
            raise ValueError("must be one of enum values ('distinct')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": DistinctParams.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "dependency": obj.get("dependency"),
            "type": obj.get("type") if obj.get("type") is not None else 'distinct'
        })
        return _obj
