...
class FileOrDirectory(BaseModel):
    """
    FileOrDirectory
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["directory", "path", "name", "metadata"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "name": obj.get("name"),
            "metadata": BlobMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None
        })
        return _obj
