...
class RenameTask(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='rename', description="Type of the rename task.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "params": RenameParams.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "dependency": obj.get("dependency"),
            "type": obj.get("type") if obj.get("type") is not None else 'rename'
        })
        return _obj
