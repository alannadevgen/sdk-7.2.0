...
class NotEqualFilter(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='not_equal', description="Operator for NOT EQUAL filter.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('not_equal'):
            raise ValueError("must be one of enum values ('not_equal')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "left": obj.get("left"),
            "right": obj.get("right"),
            "type": obj.get("type") if obj.get("type") is not None else 'not_equal'
        })
        return _obj
