...
class CreditCardDetails(Details1):
    """
    CreditCardDetails
    """ # noqa: E501
    type: Optional[StrictStr] = 'credit_card'
    number: Optional[StrictStr] = None
    cvc: Optional[StrictStr] = None
    expiration_month: Optional[StrictStr] = None
    expiration_year: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "number", "cvc", "expiration_month", "expiration_year"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'credit_card',
