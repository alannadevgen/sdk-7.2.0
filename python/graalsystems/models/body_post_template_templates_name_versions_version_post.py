...
class BodyPostTemplateTemplatesNameVersionsVersionPost(BaseModel):
    """
    BodyPostTemplateTemplatesNameVersionsVersionPost
    """ # noqa: E501
    template: StrictStr
    metadata: Metadata
    __properties: ClassVar[List[str]] = ["template", "metadata"]
