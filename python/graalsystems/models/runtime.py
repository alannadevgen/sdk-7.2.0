...
class Runtime(BaseModel):
    ...
    icon_size: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "technical_name", "description", "icon", "icon_size", "status", "enabled", "created", "updated", "labels", "dockerfile", "metadata"]
