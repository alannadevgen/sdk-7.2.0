...
class GreaterThanFilter(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='greater', description="Operator for GREATER THAN filter.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "left": obj.get("left"),
            "right": obj.get("right"),
            "type": obj.get("type") if obj.get("type") is not None else 'greater'
        })
        return _obj
