...
class DeviceApi:
    ...
    def delete_device_by_id(
        ...
        _param = self._delete_device_by_id_serialize(
            x_tenant=x_tenant,
            device_id=device_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_device_by_id_with_http_info(
        self,
        x_tenant: StrictStr,
        device_id: Annotated[StrictStr, Field(description="Id of the device")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_device_by_id_without_preload_content(
        self,
        x_tenant: StrictStr,
        device_id: Annotated[StrictStr, Field(description="Id of the device")],
        _request_timeout: Union[
    ...
    def _delete_device_by_id_serialize(
        self,
        x_tenant,
        device_id,
        _request_auth,
    ...
    def find_device_by_device_id(
        ...
        _param = self._find_device_by_device_id_serialize(
            x_tenant=x_tenant,
            device_id=device_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def find_device_by_device_id_with_http_info(
        self,
        x_tenant: StrictStr,
        device_id: Annotated[StrictStr, Field(description="Id of the device")],
        _request_timeout: Union[
    ...
    @validate_call
    def find_device_by_device_id_without_preload_content(
        self,
        x_tenant: StrictStr,
        device_id: Annotated[StrictStr, Field(description="Id of the device")],
        _request_timeout: Union[
    ...
    def _find_device_by_device_id_serialize(
        self,
        x_tenant,
        device_id,
        _request_auth,
    ...
    def find_devices(
        ...
        _param = self._find_devices_serialize(
            x_tenant=x_tenant,
            page=page,
            size=size,
            _request_auth=_request_auth,
    ...
    @validate_call
    def find_devices_with_http_info(
        self,
        x_tenant: StrictStr,
        page: Optional[StrictInt] = None,
        size: Optional[StrictInt] = None,
    ...
    @validate_call
    def find_devices_without_preload_content(
        self,
        x_tenant: StrictStr,
        page: Optional[StrictInt] = None,
        size: Optional[StrictInt] = None,
