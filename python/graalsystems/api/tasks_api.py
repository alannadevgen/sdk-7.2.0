...
class TasksApi:
    ...
    def apply_task(
        ...
        _param = self._apply_task_serialize(
            x_tenant=x_tenant,
            body=body,
    ...
    @validate_call
    def apply_task_without_preload_content(
        self,
        x_tenant: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def find_tasks(
        ...
        _param = self._find_tasks_serialize(
            x_tenant=x_tenant,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def find_tasks_without_preload_content(
        self,
        x_tenant: StrictStr,
        _request_timeout: Union[
            None,
