...
class CodeApi:
    ...
    def download_code(
        ...
        _param = self._download_code_serialize(
            x_tenant=x_tenant,
            source=source,
    ...
    @validate_call
    def download_code_with_http_info(
        self,
        x_tenant: StrictStr,
        source: Optional[StrictStr] = None,
        destination: Optional[StrictStr] = None,
    ...
    @validate_call
    def download_code_without_preload_content(
        self,
        x_tenant: StrictStr,
        source: Optional[StrictStr] = None,
        destination: Optional[StrictStr] = None,
