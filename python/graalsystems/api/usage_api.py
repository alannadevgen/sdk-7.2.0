...
class UsageApi:
    ...
    def create_usage(
        self,
        x_tenant: StrictStr,
        usage: Annotated[Usage, Field(description="The usage to be created")],
        ...
        :type x_tenant: str
        :param usage: The usage to be created (required)
        :type usage: Usage
    ...
    def _create_usage_serialize(
        ...
        _header_params['Accept'] = self.api_client.select_header_accept(
            [
                'application/vnd.graal.systems.v1.usage+json'
            ]
        )
    ...
    def find_usages(
        ...
        _param = self._find_usages_serialize(
            x_tenant=x_tenant,
            var_from=var_from,
            to=to,
            var_for=var_for,
    ...
    @validate_call
    def find_usages_with_http_info(
        self,
        x_tenant: StrictStr,
        var_from: Optional[datetime] = None,
        to: Optional[datetime] = None,
    ...
    @validate_call
    def find_usages_without_preload_content(
        self,
        x_tenant: StrictStr,
        var_from: Optional[datetime] = None,
        to: Optional[datetime] = None,
