...
class DataApi:
    ...
    def delete_files(
        ...
        path: Annotated[List[StrictStr], Field(description="path")],
    ...
    def _delete_files_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/buckets/{bucketId}/data',
    ...
    def _download_file_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/buckets/{bucketId}/data?download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_data_files(
        ...
        _param = self._get_data_files_serialize(
            x_tenant=x_tenant,
            bucket_id=bucket_id,
            path=path,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_data_files_with_http_info(
        self,
        x_tenant: StrictStr,
        bucket_id: Annotated[StrictStr, Field(description="Id of the bucket")],
        path: Annotated[StrictStr, Field(description="path")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[FileOrDirectory]]:
        """Get files
    ...
    @validate_call
    def get_data_files_without_preload_content(
        self,
        x_tenant: StrictStr,
        bucket_id: Annotated[StrictStr, Field(description="Id of the bucket")],
        path: Annotated[StrictStr, Field(description="path")],
