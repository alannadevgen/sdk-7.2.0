...
class PaymentApi:
    ...
    def find_payments(
        ...
        _param = self._find_payments_serialize(
            x_tenant=x_tenant,
    ...
    @validate_call
    def find_payments_with_http_info(
        self,
        x_tenant: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def find_payments_without_preload_content(
        self,
        x_tenant: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _find_payments_serialize(
        ...
        _header_params['Accept'] = self.api_client.select_header_accept(
            [
                'application/vnd.graal.systems.v1.payment+json'
            ]
        )
