...
class ApplicationApi:
    ...
    def create_application(
        self,
        x_tenant: StrictStr,
        application: Annotated[Application, Field(description="The application to be created")],
        ...
        :type x_tenant: str
        :param application: The application to be created (required)
    ...
    def delete_application_by_id(
        self,
        x_tenant: StrictStr,
        application_id: Annotated[StrictStr, Field(description="Id of the application")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_tenant: (required)
        :type x_tenant: str
        :param application_id: Id of the application (required)
    ...
    def find_application_by_id(
        ...
        _param = self._find_application_by_id_serialize(
            x_tenant=x_tenant,
            application_id=application_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def find_application_by_id_with_http_info(
        self,
        x_tenant: StrictStr,
        application_id: Annotated[StrictStr, Field(description="Id of the application")],
        _request_timeout: Union[
    ...
    @validate_call
    def find_application_by_id_without_preload_content(
        self,
        x_tenant: StrictStr,
        application_id: Annotated[StrictStr, Field(description="Id of the application")],
        _request_timeout: Union[
    ...
    def _find_application_by_id_serialize(
        self,
        x_tenant,
        application_id,
        _request_auth,
    ...
    def find_applications(
        ...
        _param = self._find_applications_serialize(
            x_tenant=x_tenant,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def find_applications_with_http_info(
        self,
        x_tenant: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def find_applications_without_preload_content(
        self,
        x_tenant: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _find_applications_serialize(
        self,
        x_tenant,
        _request_auth,
        _content_type,
